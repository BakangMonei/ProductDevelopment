...
const ProfileAdmin = () => {
  ...
  const fetchDetailsFromCollection = async (userId, collectionName) => {
    try {
      ...
      console.error(
        `Error fetching user details from ${collectionName}:`,
        error
      );
      return null;
    }
  ...
  if (!currentUser || !userDetails) {
    ...
    return (
      <div className="text-center item-center justify-center h-screen">
        Loading...
      </div>
    );
  }
      ...
      <div>
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Sports Broadcasters</p>
