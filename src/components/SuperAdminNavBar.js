      ...
      <div class="flex flex-col sm:flex-row sm:justify-around">
        <div class="h-screen w-72">
          <nav class="px-6 mt-10">
            ...
            <div>
              <p class="w-full pb-2 mb-4 ml-2 font-extrabold text-gray-300 border-b-2 border-gray-100 text-md">
                My Profile
              </p>
              <a
            ...
            <div>
              ...
              >
                ...
                <span class="mx-4 font-normal text-md">Create Administrators</span>
              </a>
              <a
                class="flex items-center justify-start p-2 my-4 font-thin text-gray-500 transition-colors duration-200 hover:text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600"
                href="#"
              >
                ...
                <span class="mx-4 font-normal text-md">Create Broadcastors</span>
              </a>
            </div>
            <div>
              <p class="w-full pb-2 mb-4 ml-2 font-normal text-gray-300 border-b-2 border-gray-100 text-md">
              ...
              >
                ...
                <span class="mx-4 font-normal text-md">View Logs</span>
              </a>
              <a
                class="flex items-center justify-start p-2 my-4 font-thin text-gray-500 transition-colors duration-200 hover:text-gray-800 dark:text-gray-400 hover:bg-gray-100 dark:hover:text-white dark:hover:bg-gray-600"
                href="#"
              >
                ...
                <span class="mx-4 font-normal text-md">Logout</span>
              </a>
            </div>
          </nav>
        </div>
