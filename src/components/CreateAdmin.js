...
const CreateAdmin = () => {
  ...
  return (
    <div className="flex flex-auto">
      ...
      <div className=" max-w-xl mx-auto p-4 justify-center items-center mt-40">
        {/* {generatedPassword && (
        ...
        <form onSubmit={handleRegisterAdmin} className="p-4 items-center justify-center min-h border border-gray-300 rounded-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="border rounded text-black font-mono p-1 border-gray-500 w-full"
              />
            </div>
            <div>
